...
command = "bash"
args = ["-lc", "mkdir -p /Volumes/Data/_ai/_mcp/mcp-data/iterm-mcp && cd /Volumes/Data/_ai/_mcp/mcp-data/iterm-mcp && exec npx -y iterm-mcp"]
...
- Added Codex setup example with persistent MCP data root at `/Volumes/Data/_ai/_mcp/mcp-data/iterm-mcp`.
